...
import * as strings from 'DepartPivotWebPartStrings';
import DepartPivot from './components/DepartPivot';
import { IDepartPivotProps } from './components/IDepartPivotProps';
...
export default class DepartPivotWebPart extends BaseClientSideWebPart<IDepartPivotWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IDepartPivotProps> = React.createElement(
      DepartPivot,
      {
